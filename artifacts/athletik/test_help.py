...
TEST_HELP: dict[str, dict] = {
    ...
    "y_balance": {
        ...
        "video_lokal": None, "video_link": None, "video_titel": None, "video_quelle": None, "video_lizenz": None,
        "felder": {
            "beinlaenge":     {"label": "Beinlänge", "ziel": "Normierungsbasis für den Composite Score.", "kurzhilfe": "Beinlänge in cm messen: ASIS (Beckenvorsprung) bis Innenknöchel bei gestrecktem Knie. Z. B. 87.5", "eingabehilfe": "Länge in cm, z. B. 87.5", "einheit": "cm", "bereich": "Sinnvoll: 50 – 95 cm", "bild_pfad": "assets/tests/y_balance/beinlaenge.svg"},
    ...
    "agility": {
        ...
        "felder": {
            ...
            "modified_t_test": {"label": "Modified T-Test", "ziel": "Schnelle mehrdirektionale Agilität — kürzere Version des T-Tests.", "kurzhilfe": "Gesamtzeit des Modified T-Tests in Sekunden. Start → Kegel A (9,15 m) → Kegel B links (3,66 m) → Kegel C rechts (7,32 m) → Kegel A → Start.", "eingabehilfe": "Zeit in Sekunden, z. B. 7.80", "einheit": "s", "bereich": "Sinnvoll: 6.50 – 12.00 s", "bild_pfad": "assets/tests/agility/modified_t_test.svg"},
            "pro_agility":     {"label": "Pro Agility Shuttle", "ziel": "Explosivkraft und Abbremsfähigkeit — NFL-Combine-Standard (5-10-5).", "kurzhilfe": "Gesamtzeit Pro Agility Shuttle in Sekunden: 5 yd links → 10 yd rechts → 5 yd zurück zur Mitte. Startrichtung frei wählbar.", "eingabehilfe": "Zeit in Sekunden, z. B. 4.50", "einheit": "s", "bereich": "Sinnvoll: 3.80 – 6.00 s", "bild_pfad": "assets/tests/agility/pro_agility.svg"},
            "arrowhead_r":     {"label": "Arrowhead rechts", "ziel": "Reaktive Agilität im pfeilförmigen Muster — Rechtsvariante.", "kurzhilfe": "Zeit für den Arrowhead-Test nach rechts: Start → Spitze (ca. 10 m) → Kegel rechts → zurück zum Start.", "eingabehilfe": "Zeit in Sekunden, z. B. 5.20", "einheit": "s", "bereich": "Sinnvoll: 4.00 – 7.00 s", "bild_pfad": "assets/tests/agility/arrowhead.svg"},
            "arrowhead_l":     {"label": "Arrowhead links",  "ziel": "Reaktive Agilität im pfeilförmigen Muster — Linksvariante.", "kurzhilfe": "Zeit für den Arrowhead-Test nach links: Start → Spitze → Kegel links → zurück zum Start. Seitendifferenz > 10 % = relevant.", "eingabehilfe": "Zeit in Sekunden, z. B. 5.30", "einheit": "s", "bereich": "Sinnvoll: 4.00 – 7.00 s", "bild_pfad": "assets/tests/agility/arrowhead.svg"},
            "zigzag":          {"label": "Zig-Zag Agility", "ziel": "Kurskontrolle und Richtungswechselgeschwindigkeit im Slalom.", "kurzhilfe": "Gesamtzeit Zig-Zag-Test in Sekunden (ca. 20–25 m, 4–5 Kegel im Zickzack).", "eingabehilfe": "Zeit in Sekunden, z. B. 5.50", "einheit": "s", "bereich": "Sinnvoll: 4.00 – 8.00 s", "bild_pfad": "assets/tests/agility/zigzag.svg"},
            "balsom":          {"label": "Balsom Agility Test", "ziel": "Richtungswechselausdauer — schwedischer Ausdauer-Agilitätstest.", "kurzhilfe": "Bestzeit in Sekunden über 3 Läufe à 25 s auf einem 4×4-m-Rechteck mit Mittelpunkt. Anzahl Richtungswechsel wird gezählt.", "eingabehilfe": "Zeit in Sekunden (bester Lauf), z. B. 48.00", "einheit": "s", "bereich": "Sinnvoll: 35.00 – 65.00 s", "bild_pfad": "assets/tests/agility/balsom.svg"},
        },
    },
